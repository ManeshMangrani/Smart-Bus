	...
	<nav class="navbar navbar-default">
	  <div class="container1">
	    ...
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand"><img width='40' height='25' src='<?php echo PATH; ?>images/logo.png' alt=''/></a>
	    </div>
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
	      	...
	      	<li class="dropdown" style="padding-top:8px; padding-left:4px">
	      		<form method="post" action="<?php echo site_url('index.php/message/lists') ?>"><button type="submit" class="btn btn-info">Message</button></form> <!--&nbsp; <span class="caret"></span></button>
	      		<ul class="dropdown-menu">
	      			<li><a href="<?php echo site_url('index.php/report/lists') ?>">Reporting</a></li>
	      		</ul>-->
	      	</li>
	      	<li class="dropdown" style="padding-top:8px; padding-left:4px">
	      		<button data-toggle="dropdown" class="btn btn-info dropdown-toggle">User & offer &nbsp; <span class="caret"></span></button>
	      		<ul class="dropdown-menu">
	      			...
	      			<li role="separator" class="divider"></li>
	      			<li class="dropdown-header" style=" color: blue;">About Offer</li>
