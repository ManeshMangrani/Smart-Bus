	...
	<div class="col-sm-10 col-sm-offset-2">
		...
		<form action="<?php echo site_url('index.php/user/edit') ?>" method="post" class="form-horizontal">
			...
			<div class="form-group">
				<div class="col-sm-4">
					<div><b>CNIC</b></div>
					<input id="cnic" name="cnic" type="number" placeholder="CNIC " class="form-control"
			...
			<div class="form-group">
				<div class="col-sm-4">
					<div><b>Address</b></div>
					<textarea id="address" name="address" class="form-control" required cols="40" rows="10" placeholder="Address"><?php echo $user->address ?></textarea>
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-4">
