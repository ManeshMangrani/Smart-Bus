                      ...
                      <form action="<?php echo site_url('index.php/auth/register');?>" method="post" class="rd-mailform text-left">
                        ...
                        <div class="form-group form-group-label-outside offset-top-20">
                          <select name="route" class="form-control">
                            ...
                            <option>korani</option>
                            <option>Malir</option>
                            <option>North-Nazimbad</option>
                        ...
                        <div class="form-group form-group-label-outside">
                          ...
                          <input id="register-phone" type="text" name="phone" data-constraints=" @IsNumeric @Required" class="form-control">
                        </div>
                        <div class="form-group form-group-label-outside">
                          <label for="register-cnic" class="form-label form-label-outside text-dark">CNIC</label>
                          <input id="register-cnic" type="text" name="cnic" data-constraints=" @IsNumeric @Required" class="form-control">
                        </div>
                        <div class="form-group form-group-label-outside">
